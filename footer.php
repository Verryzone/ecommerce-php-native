    ...
    <!-- Vendors JS -->
    <script src="themes/assets/vendor/libs/apex-charts/apexcharts.js"></script>
    ...
    <!-- Page JS -->
    <script src="themes/assets/js/dashboards-analytics.js"></script>
