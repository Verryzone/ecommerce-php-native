...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
      data-assets-path="themes/assets/" data-template="vertical-menu-template-free">
...
<head>
      ...
      <link rel="stylesheet" href="themes/assets/vendor/libs/apex-charts/apex-charts.css" />
      ...
      <script>const global_url = "<?php GLOBAL_URL ?>" </script>
</head>
            ...
            <div class="layout-container">
                  ...
                  <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                        <div class="app-brand demo">
                              <a href="<?= GLOBAL_URL ?>" class="app-brand-link">
                                    ...
                                    <span class="app-brand-text demo menu-text fw-bolder ms-2">e-mng</span>
                              </a>
                        ...
                        <ul class="menu-inner py-1">
                              <!-- Dashboard -->
                              <li class="menu-item <?php pageIsAktif(['dashboard']) ?>">
                                    <a href="http://localhost/pemrograman_web/ecommerce-4adm1n/" class="menu-link">
                              ...
                              <!-- Layouts -->
                              <li class="menu-item <?php pageIsAktif(['users', 'products', 'categories'], true) ?>">
                              ...
                              <li class="menu-item">
                                    <a href="?page=transactions" class="menu-link">
                                          ...
                                          <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                                <a class="nav-link dropdown-toggle hide-arrow"
                                                      ...
                                                      <div class="avatar avatar-online">
                                                            <img src="themes/assets/img/avatars/1.png" alt
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <a class="dropdown-item" href="#">
                                                                  <div class="d-flex">
                                                                        <div class="flex-shrink-0 me-3">
                                                                              <div class="avatar avatar-online">
                                                                                    <img src="themes/assets/img/avatars/1.png"
                                                                                          alt
                                                                                          class="w-px-40 h-auto rounded-circle" />
                                                                              </div>
                                                                        </div>
                                                      ...
                                                      <li>
                                                            <a class="dropdown-item" href="#">
                                                                  <span class="d-flex align-items-center align-middle">
                                                                        <i
                                                                              class="flex-shrink-0 bx bx-credit-card me-2"></i>
                                                                        <span
                                                      ...
                                                      <li>
                                                            <a class="dropdown-item" onclick="authLogout()"
